...
import components_done_tests.SimpleStudent;
...
public class JFrameAddGradesToTest extends JFrame {
	...
	public JFrameAddGradesToTest(int testID) {
		TEST_ID = testID;
					...
					});
					{
						...
						btnAddToList.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								try {
										int id = StudentUtility.getStudentIDbyFullName(f_name, l_name);
	...
	private void initAllStudents() {
		try {
			Object[][] allData = Database.executeQuery("SELECT f_name,l_name FROM Students ORDER BY f_name ASC");
