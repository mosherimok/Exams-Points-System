...
public class StudentsActions extends ButtonsActions{
	...
	public StudentsActions(JTable table){
		super(TableGetter.getTable(TblStudents.class),table,new ViewStudentRecord());
	}
...
//				ModifyStudentDetailsJDialog dialog = new ModifyStudentDetailsJDialog(oldValues);
	...
	public boolean addAction() {
		Controller controller = new Controller(VIEW,new ModelAddStudent());
